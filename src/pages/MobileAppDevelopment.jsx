        ...
        <div className="relative min-h-screen bg-brand-bg font-sans selection:bg-brand-accent selection:text-brand-dark overflow-x-hidden">
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-16 relative z-10">
                    <div className="text-center">
                        ...
                        >
                            ...
                            <span className="italic font-light text-brand-dark/70">Mobile Apps</span> <br />
                            That Power Growth.
                        </motion.h1>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-16 relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        ...
                        <div className="relative flex justify-center">
                            ...
                            >
                                <div className="w-[300px] h-[600px] border-[8px] border-white/10 rounded-[48px] overflow-hidden bg-brand-bg relative">
                                ...
                                <div className="absolute -bottom-10 -right-10 w-48 h-48 bg-brand-accent/20 rounded-full blur-3xl -z-10" />
                            </motion.div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {serviceTypes.map((service, idx) => (
                            <motion.div
                                ...
                                className="p-12 rounded-[48px] bg-white border border-brand-dark/5 hover:shadow-2xl transition-all duration-500 group"
                            >
                                ...
                                <p className="text-brand-dark/50 font-medium leading-relaxed mb-8">{service.desc}</p>
                                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    {service.points.map((point, pIdx) => (
                                        <li key={pIdx} className="flex items-center gap-3 text-sm font-bold text-brand-dark/70">
            ...
            <section className="py-24 md:py-40 bg-brand-accent/10">
                <div className="mx-auto max-w-7xl px-6 lg:px-16">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-6 text-center text-brand-dark">
                        {techStack.map((tech, idx) => (
                            ...
                            >
                                ...
                                <span className="text-sm font-bold group-hover:text-white">{tech.name}</span>
                            </motion.div>
                        ))}
                    </div>
                </div>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        {processSteps.map((step, idx) => (
                            ...
                            >
                                <span className="absolute top-8 right-10 text-5xl font-black text-brand-dark/5 group-hover:text-brand-accent/20 transition-colors">
                                    {step.id}
                                </span>
